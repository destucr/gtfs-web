    ...
    return (
        <aside className="w-[60px] lg:w-[240px] h-full bg-zinc-50 text-zinc-500 flex flex-col border-r border-zinc-200 transition-all duration-300 shrink-0 z-50">
            ...
            <div className="h-14 flex items-center justify-center lg:justify-start px-0 lg:px-4 border-b border-zinc-200 shrink-0">
                <div className="w-8 h-8 bg-blue-600 rounded flex items-center justify-center text-white shrink-0 shadow-sm shadow-blue-600/20">
                    ...
                    return (
                        <NavLink
                            ...
                            className={({ isActive }) => `
                                ...
                                ${isActive 
                                    ? 'bg-white border border-zinc-200 text-blue-600 shadow-sm font-semibold' 
            ...
            <div className="p-2 border-t border-zinc-200 shrink-0">
                <button className="w-full flex items-center justify-center lg:justify-start gap-3 p-2 rounded-md hover:bg-zinc-100 text-zinc-500 hover:text-zinc-900 transition-colors">
                    <div className="w-8 h-8 rounded bg-white flex items-center justify-center shrink-0 border border-zinc-200 text-zinc-700 shadow-sm">

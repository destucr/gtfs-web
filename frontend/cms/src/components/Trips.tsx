                ...
                >
                    <div className="p-8 pb-6 flex items-center justify-between shrink-0">
                        <div className="flex items-center gap-4">
                            <div className="w-12 h-12 rounded-2xl flex items-center justify-center bg-system-blue text-white shadow-xl shadow-system-blue/20 shrink-0 transition-transform hover:rotate-12"><Database size={24} /></div>
                            <div className="min-w-0">
                        ...
                        <button onClick={() => setSelectedTrip(null)} className="p-2.5 hover:bg-black/5 rounded-full text-system-gray transition-all hover:rotate-90 active:scale-90"><X size={20}/></button>
                    </div>
